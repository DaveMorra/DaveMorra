...
- [Smart Scheduler](https://https://davemorra.ca/smartscheduler) **Java | Springboot | TypeScript | Angular | Bootstrap**  
  Web application that optimises students class schedule using a heuristic tree search algorithm.
- [Inventory Management Website](https://davemorra.ca/inventorymanagment) **SQL | Javascript | HTML | CSS**  
