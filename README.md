...
- [Smart Scheduler](https://davemorra.ca/smartscheduler.html) **Java | Springboot | TypeScript | Angular | Bootstrap**  
  Web application that optimises students class schedule using a heuristic tree search algorithm.
- [Inventory Management Website](https://davemorra.ca/inventorymanagment.html) **SQL | Javascript | HTML | CSS**  
